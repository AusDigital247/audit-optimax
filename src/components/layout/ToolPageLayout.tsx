      ...
      <div className="bg-light-bg dark:bg-navy-light py-10 lg:py-16 w-full">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            <div className="bg-white/90 dark:bg-navy/70 p-6 md:p-8 rounded-xl shadow-lg border border-gray-300 dark:border-white/20 backdrop-blur-sm">
              {children}
            </div>
            
            {/* Related tools section - limited to max 3 internal links with improved visibility */}
              ...
              <div className="mt-12 md:mt-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {relatedTools.slice(0, 3).map((tool, index) => (
                    <div key={index} className="bg-white/90 dark:bg-navy/60 p-5 rounded-lg border border-gray-300 dark:border-white/20 hover:shadow-md transition-all backdrop-blur-sm">
                      <h3 className="text-lg font-semibold text-navy dark:text-white mb-2 font-display">{tool.name}</h3>
                      {tool.description && (
                        <p className="text-navy-dark dark:text-white/90 font-body text-sm mb-3">{tool.description}</p>
                      )}
                      <Link 
                        to={tool.path} 
                        className="inline-flex items-center text-teal-dark dark:text-teal-light text-sm hover:underline font-body font-medium"
                      >
            ...
            <div className="mt-12 text-center">
              <div className="bg-gradient-to-r from-teal/10 to-teal/20 dark:from-navy/80 dark:to-navy-light/90 p-6 rounded-lg border border-teal/40 dark:border-white/20 backdrop-blur-sm shadow-md">
                <h3 className="text-xl font-bold mb-3 text-navy dark:text-white font-display">Need More Comprehensive SEO Analysis?</h3>
                <p className="text-navy-dark dark:text-white/90 font-body mb-4">
                  Run a full <Link to="/" className="text-teal-dark hover:underline">website SEO audit</Link> to identify all optimization opportunities at once.
                </p>
                <Link 
                  to="/"
                ...
                <p className="text-navy-dark dark:text-white/80 text-sm mt-3">
                  Our <Link to="/" className="text-teal-dark dark:text-teal-light/90 hover:underline">SEO site checkup</Link> provides actionable insights to improve your search rankings
                </p>
              </div>
            </div>
          </div>
