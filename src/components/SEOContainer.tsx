      ...
      <section className="bg-gradient-to-b from-navy to-navy-light pt-12 pb-20 md:pt-20 md:pb-32 w-full">
        <div className="w-full max-w-full mx-auto px-4 md:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center mb-10">
            <div className="mb-6">
              <h1 className="text-3xl md:text-5xl font-bold mb-3 text-teal-light font-display">
                {t('seo_tool_title')}
              </h1>
              <h2 className="text-lg md:text-xl text-teal-light font-light max-w-2xl mx-auto">
                {t('hero_subtitle')}
              </h2>
            </div>
            ...
            <div className="flex items-center justify-center py-2 px-6 bg-teal/30 backdrop-blur-sm rounded-full mb-6 animated-card">
              ...
              <span className="text-teal-light text-sm font-medium">SEO Audit Tool</span>
            </div>
            
            <p className="text-teal-light max-w-2xl mx-auto mb-6">
              Discover how your website performs with our <Link to="/google-rank-checker-tool" className="text-teal-light hover:underline">search engine ranking tracker</Link> and <Link to="/keyword-generator-tool" className="text-teal-light hover:underline">semantic keyword research</Link> tools. Our <Link to="/seo-services" className="text-teal-light hover:underline">comprehensive SEO analysis</Link> helps businesses improve their online visibility.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto" id="seo-tool">
            <div className="glass-card p-8 md:p-10 rounded-xl shadow-2xl border border-teal/30 animate-pulse-glow">
              <h3 className="text-2xl font-bold mb-6 text-center text-teal-light font-display">
                {t('seo_tool_title')}
              </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16 px-4 md:px-6">
            <div className="glass-card p-6 rounded-xl animated-card">
              ...
              <h3 className="text-xl font-semibold mb-2 text-teal-light font-display">{t('comprehensive_analysis')}</h3>
              <p className="text-teal-light font-body">{t('comprehensive_text')}</p>
              <Link to="/blog" className="text-teal-light hover:text-white text-sm mt-3 inline-block">Learn about our SEO strategies →</Link>
            </div>
            ...
            <div className="glass-card p-6 rounded-xl animated-card">
              ...
              <h3 className="text-xl font-semibold mb-2 text-teal-light font-display">{t('actionable_insights')}</h3>
              <p className="text-teal-light font-body">{t('actionable_text')}</p>
              <Link to="/local-seo" className="text-teal-light hover:text-white text-sm mt-3 inline-block">Explore local optimization →</Link>
            </div>
            ...
            <div className="glass-card p-6 rounded-xl animated-card">
              ...
              <h3 className="text-xl font-semibold mb-2 text-teal-light font-display">{t('track_progress')}</h3>
              <p className="text-teal-light font-body">{t('progress_text')}</p>
              <Link to="/sentence-rewriter-tool" className="text-teal-light hover:text-white text-sm mt-3 inline-block">Improve content quality →</Link>
            </div>
            ...
            <div className="glass-card p-6 rounded-xl animated-card">
              ...
              <h3 className="text-xl font-bold mb-2 text-teal-light font-display">Complete SEO Audit</h3>
              <p className="text-teal-light font-body">Get a comprehensive report of your site's SEO performance.</p>
              <Link to="/blog-ideas-generator-tool" className="text-teal-light hover:text-white text-sm mt-3 inline-block">Generate content ideas →</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-light-bg dark:bg-navy-light py-16 w-full">
        <div className="w-full max-w-full mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-navy dark:text-teal-light font-display">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-navy to-teal dark:from-teal-light dark:to-white">
                Why Choose Our SEO Audit Tool?
              </span>
            </h2>
            <p className="text-lg text-navy-light dark:text-teal-light max-w-3xl mx-auto font-body">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4 md:px-6">
            <div className="glass-card-hover p-6 rounded-xl">
              ...
              <h3 className="text-xl font-bold mb-3 text-navy dark:text-teal-light font-display">Website Performance</h3>
              <p className="text-navy-light dark:text-teal-light font-body">
            ...
            <div className="glass-card-hover p-6 rounded-xl">
              ...
              <h3 className="text-xl font-bold mb-3 text-navy dark:text-teal-light font-display">Keyword Strategy</h3>
              <p className="text-navy-light dark:text-teal-light font-body">
            ...
            <div className="glass-card-hover p-6 rounded-xl">
              ...
              <h3 className="text-xl font-bold mb-3 text-navy dark:text-teal-light font-display">Competitor Analysis</h3>
              <p className="text-navy-light dark:text-teal-light font-body">
      ...
      <section className="bg-white dark:bg-navy py-16 w-full">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold mb-6 text-navy dark:text-teal-light text-center font-display">Free SEO Audit Tool</h2>
            <p className="text-navy-light dark:text-teal-light mb-6 font-body">
            ...
            <div className="mt-12">
              <h3 className="text-xl font-bold mb-4 text-navy dark:text-teal-light font-display">What Our Tool Analyzes</h3>
              <ul className="list-disc pl-5 space-y-2 text-navy-light dark:text-teal-light font-body">
            ...
            <div className="mt-12">
              <h3 className="text-xl font-bold mb-4 text-navy dark:text-teal-light font-display">Why Choose Our Tool</h3>
              <p className="text-navy-light dark:text-teal-light font-body">
            ...
            <div className="mt-12">
              <h3 className="text-xl font-bold mb-4 text-navy dark:text-teal-light font-display">How to Get Started</h3>
              <p className="text-navy-light dark:text-teal-light font-body">
