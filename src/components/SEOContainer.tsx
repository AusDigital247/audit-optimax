      ...
      <section className="bg-gradient-to-b from-navy to-navy-light pt-12 pb-20 md:pt-20 md:pb-32 w-full">
        <div className="w-full max-w-full mx-auto px-4 md:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center mb-10">
            <div className="mb-6">
              <h1 className="text-3xl md:text-5xl font-bold mb-3 text-white font-display">
                {t('seo_tool_title')}
              </h1>
              <h2 className="text-lg md:text-xl text-white font-light max-w-2xl mx-auto">
                {t('hero_subtitle')}
              </h2>
            </div>
          ...
          <div className="max-w-3xl mx-auto" id="seo-tool">
            <div className="glass-card p-8 md:p-10 rounded-xl shadow-2xl border border-teal/30 animate-pulse-glow">
              <h3 className="text-2xl font-bold mb-6 text-center text-white font-display">
                {t('seo_tool_title')}
              </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16 px-4 md:px-6">
            <div className="glass-card p-6 rounded-xl animated-card">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white font-display">{t('comprehensive_analysis')}</h3>
              <p className="text-white font-body">{t('comprehensive_text')}</p>
            ...
            <div className="glass-card p-6 rounded-xl animated-card">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white font-display">{t('actionable_insights')}</h3>
              <p className="text-white font-body">{t('actionable_text')}</p>
            ...
            <div className="glass-card p-6 rounded-xl animated-card">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white font-display">{t('track_progress')}</h3>
              <p className="text-white font-body">{t('progress_text')}</p>
            ...
            <div className="glass-card p-6 rounded-xl animated-card">
              ...
              <h3 className="text-xl font-bold mb-2 text-white font-display">Complete SEO Audit</h3>
              <p className="text-white font-body">Get a comprehensive report of your site's SEO performance.</p>
      ...
      <section className="bg-light-bg dark:bg-navy-light py-16 w-full">
        <div className="w-full max-w-full mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-navy dark:text-white font-display">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4 md:px-6">
            <div className="glass-card-hover p-6 rounded-xl">
              <div className="bg-teal/10 dark:bg-teal/20 p-4 rounded-full w-fit mb-5">
                <Gauge className="h-8 w-8 text-teal dark:text-white" />
              </div>
              <h3 className="text-xl font-bold mb-3 text-navy dark:text-white font-display">Website Performance</h3>
              <p className="text-navy-light dark:text-white/80 font-body">
            ...
            <div className="glass-card-hover p-6 rounded-xl">
              <div className="bg-teal/10 dark:bg-teal/20 p-4 rounded-full w-fit mb-5">
                <Target className="h-8 w-8 text-teal dark:text-white" />
              </div>
              <h3 className="text-xl font-bold mb-3 text-navy dark:text-white font-display">Keyword Strategy</h3>
              <p className="text-navy-light dark:text-white/80 font-body">
            ...
            <div className="glass-card-hover p-6 rounded-xl">
              <div className="bg-teal/10 dark:bg-teal/20 p-4 rounded-full w-fit mb-5">
                <Rocket className="h-8 w-8 text-teal dark:text-white" />
              </div>
              <h3 className="text-xl font-bold mb-3 text-navy dark:text-white font-display">Competitor Analysis</h3>
              <p className="text-navy-light dark:text-white/80 font-body">
      ...
      <section className="bg-white dark:bg-navy py-16 w-full">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold mb-6 text-navy dark:text-white text-center font-display">Free SEO Audit Tool</h2>
            <p className="text-navy-light dark:text-white/80 mb-6 font-body">
            ...
            <div className="mt-12">
              <h3 className="text-xl font-bold mb-4 text-navy dark:text-white font-display">What Our Tool Analyzes</h3>
              <ul className="list-disc pl-5 space-y-2 text-navy-light dark:text-white/80 font-body">
            ...
            <div className="mt-12">
              <h3 className="text-xl font-bold mb-4 text-navy dark:text-white font-display">Why Choose Our Tool</h3>
              <p className="text-navy-light dark:text-white/80 font-body">
            ...
            <div className="mt-12">
              <h3 className="text-xl font-bold mb-4 text-navy dark:text-white font-display">How to Get Started</h3>
              <p className="text-navy-light dark:text-white/80 font-body">
