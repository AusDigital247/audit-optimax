...
const SentenceRewriter = () => {
  ...
  return (
    <div className="w-full min-h-screen">
      <SEOHead
        title="AI Sentence Rewriter Tool | Improve Clarity and Impact"
        description="Enhance your writing with our free AI sentence rewriter tool. Transform ordinary sentences into clear, engaging, and impactful statements while maintaining your original meaning."
        ...
        canonicalPath="/tools/sentence-rewriter"
      />
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
            Transform ordinary sentences into clear, engaging, and impactful statements. Improve readability, eliminate awkward phrasing, and enhance your writing quality.
          </p>
        </div>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-4xl mx-auto">
          ...
          <p>
            An AI Sentence Rewriter is an advanced tool that uses artificial intelligence to transform ordinary sentences into clearer, more effective versions while preserving their original meaning. This technology analyzes your input sentence, understands its context, and regenerates it with improved structure, vocabulary, and flow.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
            <div className="bg-white dark:bg-navy-light p-6 rounded-lg shadow">
              <h3 className="text-xl font-semibold mb-3">Step 1: Analysis</h3>
              <p>Our AI analyzes your sentence's structure, grammar, vocabulary, and overall readability to identify improvement opportunities.</p>
            </div>
            
            <div className="bg-white dark:bg-navy-light p-6 rounded-lg shadow">
              <h3 className="text-xl font-semibold mb-3">Step 2: Processing</h3>
              <p>The system processes the sentence through advanced language models to generate alternative phrasings that enhance clarity and impact.</p>
            </div>
            
            <div className="bg-white dark:bg-navy-light p-6 rounded-lg shadow">
              <h3 className="text-xl font-semibold mb-3">Step 3: Refinement</h3>
              <p>Final adjustments ensure the rewritten sentence maintains your intended meaning while improving structure and readability.</p>
            </div>
          </div>
