...
const ParaphrasingTool = () => {
  ...
  const relatedTools = [
    ...
    },
    {
      ...
      description: "Transform entire paragraphs for improved readability"
    }
  ];
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="p-6 shadow-lg h-full flex flex-col">
          <div className="mb-4 flex justify-between items-center">
            <Label htmlFor="inputText" className="text-lg font-medium text-navy dark:text-white">Original Text</Label>
            <select 
              value={style}
              onChange={(e) => setStyle(e.target.value)}
              className="p-2 border rounded-md bg-white dark:bg-navy/50 dark:border-gray-700 dark:text-white"
            >
        ...
        <Card className="p-6 shadow-lg h-full flex flex-col">
          <div className="mb-4 flex justify-between items-center">
            <Label className="text-lg font-medium text-navy dark:text-white">Paraphrased Text</Label>
            {paraphrasedText && (
      ...
      <div className="mt-12 space-y-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="p-6 shadow-md bg-white/80 dark:bg-navy/50">
        ...
        <div className="bg-white/80 dark:bg-navy/50 p-6 rounded-lg shadow-md border border-gray-200 dark:border-white/10">
